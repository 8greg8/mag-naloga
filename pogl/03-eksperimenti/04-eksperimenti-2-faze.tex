...
\begin{figure}[htb]
	...
	\caption[Določitev amplitudnega faktorja]{Določitev amplitudnega faktorja. Amplitudni faktor $f_A$ smo določili kot dolžino diagonale modrega okvirja.}
	\label{fig:diag-bbox}
\end{figure}
...
\begin{table}[htb]
	...
	\begin{tabular}{l S[table-format=3] S[table-format=3]}
		...
		\bottomrule
	\end{tabular}
	\caption{Tabela izbranih točk okvirja merjenca, s katerimi smo določili amplitudni faktor.}
	\label{tab:diag}
\end{table}
...
\begin{figure}[!htb]
	...
	\begin{subfigure}{0.45\columnwidth}
		\includegraphics[width=\columnwidth]{./Slike/stage2-lab-sv-tracked.png}
		\caption{Stranska slika.}
	\end{subfigure}
	~
	\begin{subfigure}{0.45\columnwidth}
		\includegraphics[width=\columnwidth]{./Slike/stage2-lab-bv-tracked.png}
		\caption{Hrbtna slika.}
	\end{subfigure}
	\caption[Stranski in hrbtni posnetek iz Kinect kamere v laboratoriju]{Stranski in hrbtni posnetek iz Kinect kamere v laboratoriju. Sliki sta bili registrirani na korespondečno globinsko sliko. Črni slikovni elementi predstavljajo točke, kjer globina ni bila pravilno zajeta. Zeleni okvir je rezultat sledenja s KCF sledilnikom.}
...
\begin{figure}[!htb]
	\centering
	\begin{subfigure}[t]{0.45\columnwidth}
		\includegraphics[width=\columnwidth]{./Slike/stage2-lab-sf-sv-depth.png}
		\caption{Stranska slika.}
	\end{subfigure}
	~
	\begin{subfigure}[t]{0.45\columnwidth}
		\includegraphics[width=\columnwidth]{./Slike/stage2-lab-sf-bv-depth.png}
		\caption{Hrbtna slika.}
	\end{subfigure}
	\caption[Stranska in hrbtna globinska slika laboratorijskih eksperimentov]{Stranska in hrbtna globinska slika laboratorijskih eksperimentov. Globinski sliki sta korespondečni RGB slikam \ref{fig:primer-posnetka-stage2}. Barvna skala prikazuje globino v metrih.}
...
\begin{figure}[!htb]
	...
	\begin{subfigure}[t]{0.45\columnwidth}
		\centering
		\includegraphics[width=0.5\columnwidth, frame]{./Slike/stage2-lab-of-sv-flo-corrected.png}
		\caption{Stranska slika.}
	\end{subfigure}
	~
	\begin{subfigure}[t]{0.45\columnwidth}
		\centering
		\includegraphics[width=0.5\columnwidth, frame]{./Slike/stage2-lab-of-bv-flo-corrected.png}
		\caption{Hrbtna slika.}
	\end{subfigure}
	~
	\begin{subfigure}[t]{0.45\columnwidth}
		\includegraphics[width=\columnwidth]{./Slike/stage2-lab-of-sv-hist.png}
		\caption{Stranska slika.}
	\end{subfigure}
	~
	\begin{subfigure}[t]{0.45\columnwidth}
		\includegraphics[width=\columnwidth]{./Slike/stage2-lab-of-bv-hist.png}
		\caption{Hrbtna slika.}
	\end{subfigure}
    \caption[Stranski in hrbtni optični tok ter pripadajoča deskriptorja]{Stranski in hrbtni optični tok ter pripadajoča deskriptorja. Gre za optična toka 149. stranske in hrbtne slike merjenca SUBJ1, ki sta že obrezani. Predstavljata področje merjenca. Njima pripadata izračunana HOOF-HAFA histograma.}
...
\begin{figure}[!htb]
	...
	\begin{subfigure}[t]{0.45\columnwidth}
		...
		\caption{hrbtna slika}
	\end{subfigure}
	\caption[Stranski in hrbtni prostorski tok]{Stranski in hrbtni prostorski tok. Gre za prostorska toka 149. stranske in hrbtne slike merjenca SUBJ1, ki sta že obrezani. Predstavljata področje merjenca.}
...
\begin{figure}[!htbp]
	...
	\end{subfigure}
	\caption{Prikaz določitve zakasnitve za posameznega merjenca.}
...
\begin{figure}[!htb]
	...
	\begin{subfigure}[t]{0.45\columnwidth}
		\centering
		\includegraphics[width=0.5\columnwidth, frame]{./Slike/stage2-field-of-svbv-flo-corrected.png}
		\caption{Stranska slika.}
	\end{subfigure}
	~
	\begin{subfigure}[t]{0.45\columnwidth}
		\centering
		\includegraphics[width=0.5\columnwidth, frame]{./Slike/stage2-field-sf-svbv-flo-corrected.png}
		\caption{Hrbtna slika.}
	\end{subfigure}
	\caption{Primerjava med prostorskim in optičnim tokom.}
...
\begin{figure}[!htb]
	...
	\begin{subfigure}{0.45\columnwidth}
		\centering
		\includegraphics[width=\columnwidth]{./Slike/stage2-field-of-left-tracked.png}
		\caption{KCF sledilnik}
	\end{subfigure}
	~
	\begin{subfigure}{0.45\columnwidth}
		\centering
		\includegraphics[width=\columnwidth]{./Slike/stage2-field-sf-left-tracked.png}
		\caption{DS-KCF sledilnik.}
	\end{subfigure}
	\caption{Primerjava med KCF in DS-KCF sledilnikom za merjenca SUBJ9.}
...
\begin{figure}[!htb]
	\centering
		\includegraphics[width=0.6\columnwidth]{./Slike/squash-postavitev-corrected.jpg}	
...
\begin{figure}[!htb]
	\centering
	\begin{subfigure}[t]{0.45\columnwidth}
		\includegraphics[width=\columnwidth]{./Slike/stage2-field-sf-left-depth.png}
		\caption{Stranska slika.}
	\end{subfigure}
	~
	\begin{subfigure}[t]{0.45\columnwidth}
		\includegraphics[width=\columnwidth]{./Slike/stage2-field-sf-right-depth.png}
		\caption{Hrbtna slika.}
	\end{subfigure}
