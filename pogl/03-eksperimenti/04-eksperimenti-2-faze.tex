...
\begin{figure}[!htb]
	...
	\begin{subfigure}[t]{0.45\columnwidth}
		\centering
		\includegraphics[width=1.2\columnwidth]{./Slike/stage2-lab-sf-sv-depth.png}
		\caption{Stranska slika.}
	\end{subfigure}
	~
	\begin{subfigure}[t]{0.45\columnwidth}
		\centering
		\includegraphics[width=1.2\columnwidth]{./Slike/stage2-lab-sf-bv-depth.png}
		\caption{Hrbtna slika.}
	\end{subfigure}
...
\begin{figure}[!htb]
	...
	\begin{subfigure}[t]{0.45\columnwidth}
		\centering
		\includegraphics[width=\columnwidth, frame]{./Slike/stage2-lab-sf-pdflow-corrected.jpg}
		\caption{Stranska slika.}
	\end{subfigure}
	~
	\begin{subfigure}[t]{0.45\columnwidth}
