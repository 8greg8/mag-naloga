...
\begin{table}[!htb]
	...
	\begin{tabular}{l S[table-format=3] S[table-format=3]}
		\toprule
		\emph{Točka} & \thead{$\mathbf{x}$} & \thead{$\mathbf{y}$} \\ 
		\midrule
		$P_0$ & 297 & 82 \\
		$P_1$ & 389 & 452 \\
		\bottomrule
...
\begin{table}[htb]
	...
	\begin{tabular}{l S[table-format=3] S[table-format=1.3] S[table-format=1.1] S[table-format=1.3]}
		\toprule
		\emph{Model} & \thead{$\mathbf{C}$} & \thead{$\mathbf{\gamma}$} & \thead{$\mathbf{\nu}$} & \thead{MSE} \\ 
		\midrule
...
\begin{table}[!htb]
	...
	\begin{tabular}{l l S[table-format=3.3] | l l S[table-format=3.3]}
		\toprule
		\emph{Pogled} & \emph{Merjenec} & \thead{$\mathbf{f_A}$} & \emph{Pogled} & \emph{Merjenec} & \thead{$\mathbf{f_A}$} \\
		\midrule
		\multirow{7}{*}{hrbtni}
