...
\begin{figure}[!htb]
	...
	\begin{subfigure}[t]{0.45\columnwidth}
		\centering
		\includegraphics[width=0.6\columnwidth]{projective-bv-150.png}
...
\begin{figure}[!htb]
	...
	\begin{subfigure}[t]{0.45\columnwidth}
		\centering
		\includegraphics[width=0.6\columnwidth, frame]{stage1-squash-flo-corrected.png}
		\caption{Slika optičnega toka.}
		\label{fig:of-squash}
	\end{subfigure}
...
\begin{figure}[!htb]
	\centering
	\input{./Slike/diagram-procesiranja-field-stage1.tikz}
...
\begin{figure}[htb]
	...
	\begin{subfigure}[t]{0.45\columnwidth}
		\centering
		\includegraphics[width=0.75\columnwidth]{breathtest-500.png}
	...
	\begin{subfigure}[t]{0.45\columnwidth}
		\centering
		\includegraphics[width=0.75\columnwidth, frame]{breathtest-flow-coding.png}
...
\begin{figure}[htb]
	\centering
	\input{./Slike/diagram-procesiranja-dihanje.tikz}
