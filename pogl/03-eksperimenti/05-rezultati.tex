...
\begin{figure}[!htbp]
	...
	\end{subfigure}
	\caption[Primerjava modelov z deskriptorji HOOF in HOOF-HAFA]{Primerjava grafov korelacij modelov z različnimi deskriptorji. Model \subref{fig:izbira-hoof}) smo naučili z deskriptorjem HOOF. Model \subref{fig:izbira-hoofhafa}) smo naučili z deskriptorjem HOOF-HAFA. Posamezni vzorec je vseboval $120$ značilk. Pri primerjavi korelacije lahko opazimo vidno razliko. Model \subref{fig:izbira-hoofhafa}) dokazuje, da je razširjeni deskriptor boljši.}
	\label{fig:izbira}
\end{figure}
...
\begin{figure}[!htbp]
	...
	\caption[Krivulja ROC za detekcijo dihanja]{Krivulja ROC za detekcijo dihanja.}
