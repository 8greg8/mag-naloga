...
\begin{table}[!htb]
    ...
    \toprule
    \emph{Metoda} & \multicolumn{1}{c}{$\mathbf{\chi^2}$} & \multicolumn{1}{c}{\emph{$e$ [\%]}} \\
    \midrule
    SOPLAY 1 & 77.60 & 8.68  \\
    SOPLAY 2 & 93.10 & 9.60 \\
    \emph{CAM} & \boldentry{2}{2}{36.40} & \boldentry{1}{2}{5.32} \\
    \bottomrule
    \end{tabular}
...
\begin{table}[!htb]
    ...
    S[table-format=1.3]}
    \toprule
    \emph{Model} & \multicolumn{1}{c}{\emph{$RMSE$} [\si{\kJ}]} & \multicolumn{1}{c}{\emph{$e$ [\%]}} & \multicolumn{1}{c}{\emph{$CCC$}} \\
    \midrule
    \emph{GPR} & \boldentry{2}{3}{8.384} &  35.64 & \boldentry{1}{3}{0.879} \\
