...
\input{./pogl/03-eksperimenti-in-rezultati.tex}
\input{./pogl/04-diskusija.tex}

%**************** LITERATURA ************************
\bibliographystyle{ieeetrslo}
\bibliography{./bib/physical-activity,./bib/related-work,./bib/fatigue,./bib/sleep-apnoea,./bib/hr-motion-sensor,./bib/metabolism,./bib/methods} 
