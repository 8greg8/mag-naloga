...
\input{./pogl/002-seznam-simbolov.tex}

%------------------------ GLAVNI DEL ------------------------------------
\mainmatter
%-------------------------------------------------------------------------
%********************* POVZETEK V SLOVEN??INI ****************************
\input{./pogl/003-povzetek-sl.tex}

%*************************** POVZETEK V ANGLE??INI ***********************
\input{./pogl/004-povzetek-en.tex}

%***************************** UVOD **************************************
\input{./01-uvod/01-uvod.tex}

%*********************** OSREDNJA POGLAVJA ********************************
\input{./02-metode/02-metode.tex}
\input{./03-eksperimenti/01-eksperimenti-in-rezultati.tex}
\input{./pogl/04-diskusija.tex}

%**************** LITERATURA ************************
\bibliographystyle{ieeetrslo}
\bibliography{./bib/physical-activity,./bib/related-work,./bib/fatigue,./bib/sleep-apnoea,./bib/hr-motion-sensor,./bib/metabolism,./bib/methods,./bib/optical-flow,./bib/scene-flow,./bib/svm.bib,./bib/tracking.bib,./bib/filters.bib} 
